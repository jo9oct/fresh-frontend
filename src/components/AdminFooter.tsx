...
const AdminFooter: React.FC = () => {
  ...
  // State to control visibility of Privacy Policy and Terms modals
  const [showPrivacy, setShowPrivacy] = useState<Boolean>(false); 
  const [ShowTerms, setShowTerms] = useState<Boolean>(false); 

  // Close modals when clicking outside of modal content (backdrop click)
  const handleBackdropClick = (e: React.MouseEvent<HTMLDivElement>) => {
    if (e.target === e.currentTarget) {
      setShowPrivacy(false); // Hide Privacy modal
          ...
          <div className="row gy-5">
            <div className="col-12 col-md-5 d-flex flex-column gap-3">
              <div className="d-flex align-items-center gap-3">
                ...
                <h4 className="mb-0">
                  Freshman <span style={{ color: "#179227" }}>EXAM</span>
                </h4>
              </div>
              <p>
                Empowering Ethiopian university freshman students with
                comprehensive exam preparation resources and practice quizzes.
              </p>
              <img
                src="/public/images__1_-removebg-preview.png"
                alt="Ethiopia"
                width={84}
                height={65}
              />
            ...
            <div className="my-3 pt-3 border-top border-light ">
              <p className="text-center mb-0">
                © 2024 FreshmanExam.com. All rights reserved. Made with ❤️ for
                Ethiopian students.
              </p>
            </div>
          </div>
